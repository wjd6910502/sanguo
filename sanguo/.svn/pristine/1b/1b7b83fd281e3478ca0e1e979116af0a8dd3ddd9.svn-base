...
//char ALog::m_szLogDir[AMAX_PATH] = "Logs";
...
void a_LogOutput(int iLevel, const char* szMsg, ...)
{
  ...
  _vsnprintf(szBuf+nOffset, sizeof (szBuf)-4, szMsg, vaList);
  va_end(vaList);
...
{
  //strncpy(m_szLogDir, szLogDir, AMAX_PATH);
