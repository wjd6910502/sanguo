...
static GNET::Protocol::Type _state_GMAdapterServer[] = 
{
	...
	PROTOCOL_GMCMD_ADDSERVERREWARD,
	PROTOCOL_GMCMD_LISTSERVERREWARD,
	PROTOCOL_GMCMD_REMOVESERVERREWARD,
	PROTOCOL_GMCMD_MAILTOPLAYER,
};
...
static GNET::Protocol::Type _state_LaohuProxyClient[] = 
{
	PROTOCOL_LAOHU_CHECKTOKEN_RE,
};

GNET::Protocol::Manager::Session::State state_LaohuProxyClient(_state_LaohuProxyClient,
						sizeof(_state_LaohuProxyClient)/sizeof(GNET::Protocol::Type), 86400);

static GNET::Protocol::Type _state_LaohuInformServer[] = 
{
	PROTOCOL_LAOHU_PAY,
};

GNET::Protocol::Manager::Session::State state_LaohuInformServer(_state_LaohuInformServer,
						sizeof(_state_LaohuInformServer)/sizeof(GNET::Protocol::Type), 86400);
