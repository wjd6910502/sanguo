#ifndef __GNET_LOCALDEFS_H
#define __GNET_LOCALDEFS_H
...
#include <inttypes.h>   //for print format macros, sush as PRId64, PRId32...
#endif

#define PRINT64 "%" PRId64
#define PRINTUID PRINT64
...
namespace GNET
{
	...
	public:
		...
		IntOctets (int l_int = -1, const Octets &l_octets = Octets()) : m_int(l_int), m_octets(l_octets) { }
