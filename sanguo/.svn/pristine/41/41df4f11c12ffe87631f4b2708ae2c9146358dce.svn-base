...
function classDeclaration:outchecktype (narg)
 ...
 elseif t then
	...
	return '(!tolua_isvalue(tolua_S,'..narg..',0,&tolua_err) || tolua_isvaluenil(tolua_S,'..narg..',&tolua_err) || !tolua_is'..t..'(tolua_S,'..narg..','..def..',&tolua_err))'
 else
  local is_func = get_is_function(self.type)
  if self.ptr == '&' or self.ptr == '' then
  	return '(!tolua_isvalue(tolua_S,'..narg..',0,&tolua_err) || tolua_isvaluenil(tolua_S,'..narg..',&tolua_err) || !'..is_func..'(tolua_S,'..narg..',"'..self.type..'",'..def..',&tolua_err))'
  else
