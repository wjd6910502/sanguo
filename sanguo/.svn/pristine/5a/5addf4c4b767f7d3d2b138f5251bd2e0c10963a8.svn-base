...
--		if role1==nil and my_pvp._data._fighter1._id:ToStr()==role._roledata._base._id:ToStr() then role1=role end
--		local role2 = others.roles[my_pvp._data._fighter2._id:ToStr()]
--		if role2==nil and my_pvp._data._fighter2._id:ToStr()==role._roledata._base._id:ToStr() then role2=role end
