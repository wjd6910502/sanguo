...
def main():
	try:
		sock = init()
		if doCmd(sock, """<cmd_command cmd_data="GetAccCharList" accid="bai27"/>"""): #TODO: 加新命令只改这1行就够了
		...
		#if doCmd(sock, """<cmd_command cmd_data="DelForbidWord" words=""/>"""): #TODO: 加新命令只改这1行就够了
			print "succeed"
			return 0
		else:
			return 1
