...
SGT_Mafia_Info::SGT_Mafia_Info(): Singleton("SGT_Mafia_Info")
{
...
void SGT_Mafia_Info::backup(const char *name, int64_t transaction_id)
{
...
void SGT_Mafia_Info::restore(int64_t transaction_id)
{
	if(transaction_id == _transaction_id)
	{
