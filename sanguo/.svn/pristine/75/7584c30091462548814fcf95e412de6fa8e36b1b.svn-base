...
G_ERRCODE["EXE_OUT_OF_DATE"] = 10   --版本太旧，请更新资源以后再来参加对战
G_ERRCODE["VIP_LEVEL_LESS"] = 11   --VIP等级不足，请提升VIP等级以后再来参加
...
G_ERRCODE["MAFIA_NOT_EXIST"] = 128		--帮会不存在
G_ERRCODE["MAFIA_MAIL_LEVEL_ERR"] = 129		--没有发帮会邮件的权限
G_ERRCODE["MAFIA_BROADCAT_TIME_ERR"] = 130		--不可以发布
...
G_ERRCODE["TASK_HAVE_FINISH"]  = 206 --这个任务已经完成

G_ERRCODE["FUDAI_HAVE_GET"]    = 231 --今天已经领取了福袋奖励
G_ERRCODE["FUDAI_BUY_FIRST"]    = 232 --请首先购买了福袋，才可以领取福袋奖励
G_ERRCODE["FUDAI_TICKET_NOT_EXIST"] = 233         --福袋彩票物品不存在
...
G_ERRCODE["MONEYPILES_ERR"] = 317 --钱堆掉落次数错误
G_ERRCODE["CHESTS_ERR"] = 318 --宝箱掉落次数错误
G_ERRCODE["NO_MONEYPILES"] = 319 --本关没有钱堆掉落
G_ERRCODE["NO_CHESTS"] = 320 --本关没有宝箱掉落
G_ERRCODE["MONEY_DROPDATA_ERR"] = 321 --策划钱堆掉落配置有误
...
G_ERRCODE["PVP_LATENCY_ING"] = 415 --正在获取自己的延迟信息
...
G_ERRCODE["BLACKLIST_NOT_HAVE"] = 463--对方不在你的黑名单里面
...
G_ERRCODE["PRIVATE_SHOP_CONNOT_BUY_REFRESH_TIME"] = 552 --商店无法购买刷新次数
G_ERRCODE["PRIVATE_SHOP_REFRESH_TIME_MAX"] = 553 --商店购买刷新次数达到上限
...
G_ERRCODE["BATTLE_STATE_NO_MOVE"] = 588--当前状态直接进攻就可以了，不需要移动
...
G_ERRCODE["BATTLE_HERO_SIZE"] = 606		--只能设置一个武将
...
G_ERRCODE["LOTTERY_COSTYPE_ERROR"] = 625 --抽奖表参数类型错误
G_ERRCODE["LOTTERY_DROPITEM_ERROR"] = 626 --掉落物品不存在
G_ERRCODE["LOTTERY_DROPITEM_count_ERROR"] = 627 --掉落物品数量错误
G_ERRCODE["LOTTERY_ITEM_ERROR"] = 628 --抽奖物品配表找不到
G_ERRCODE["LOTTERY_NO_FREE"] = 629 --不可以进行免费抽奖


G_ERRCODE["DAILY_SIGN_HAVE"] = 630 	--今天已经进行了签到
G_ERRCODE["DAILY_RESIGN_ERR"] = 631 	--没有补签的机会了
G_ERRCODE["DAILY_DATA_ERR"] = 632     --策划表数据错误
G_ERRCODE["LOTTERY_FREE_CD"] = 633 	--还在CD中，现在还不可以抽奖
...
G_ERRCODE["JJC_HERO_ZERO"] = 655 	--JJC阵容不可以是空的,请先设置阵容再来挑战
...
G_ERRCODE["WEAPON_PROP_LVUP_TYPE"] = 682	--武器印升级类型错误
G_ERRCODE["WEAPON_HAVED_STRENGTH"] = 683    --已经觉醒
G_ERRCODE["WEAPON_LEVELUP_COST_NOT_HAVE"] = 684    --消耗的武器不存在
G_ERRCODE["WEAPON_FORGE_ARG_ERROR"] = 685	--武器锻造参数错误
G_ERRCODE["WEAPON_FORGE_ITEM_ERROR"] = 686   --武器锻造材料不足
G_ERRCODE["WEAPON_FORGE_MONEY_ERROR"] = 687   --武器锻造刷新武器印金币不足
G_ERRCODE["WEAPON_FORGE_YUANBAO_ERROR"] = 688   --武器锻造刷新武器印元宝不足
G_ERRCODE["WEAPON_FORGE_RESET_ERROR"] = 689	 --不可刷新

G_ERRCODE["WEAPON_FORGE_LIMIT"] = 690 --达到上限
G_ERRCODE["WEAPON_FORGE_ACTIVE"] = 691 --已经激活
G_ERRCODE["WEAPON_FORGE_NO_ACTIVE"] = 692 --尚未获得武器
G_ERRCODE["WEAPON_FORGE_LIMIT_LEVEL"] = 693 --图鉴满级
G_ERRCODE["WEAPON_FORGE_TIME"] = 694 --领取道具时间没到
...
G_ERRCODE["TRIAL_ACTIVE_HAS_REFRESH"] = 706 --已经刷新过了   把这个修改成没有次数了，无法重置
...
G_ERRCODE["TRIAL_ACTIVE_REWARD_FLAG_NOT_RECONGIZE"] = 720 -- 奖励类型不可识别
...
G_ERRCODE["EQUIPMENT_UNEQUIP_MONEY_LESS"] = 745 --脱下装备所需的金钱不足
G_ERRCODE["EQUIPMENT_NO_LEVELUP_EQUIP"] = 746 --武将没有可升级的装备
...
G_ERRCODE["USE_ITEM_KEY_NUM_MAX"] = 785 --今天箱子的开启次数达到了上限
...
G_ERRCODE["ACTIVE_CODE_INVALID"]        = 841 --错误领奖码
G_ERRCODE["ACTIVE_CODE_USED"]           = 842 --使用次数达到上限
G_ERRCODE["ACTIVE_CODE_TYPE"]           = 843 --找不到对应类型的领奖码
G_ERRCODE["ACTIVE_CODE_TIME"]           = 844 --不在领取有效期
...
G_ERRCODE["JIEYI_INVITEROLE_NOT_EXIST"] = 870 --邀请的角色不存在
G_ERRCODE["JIEYI_INVITEROLE_NOT_ONLINE"] = 871 --邀请的角色不在线
G_ERRCODE["JIEYI_INVITEROLE_HAS_JIEYI"] = 872 --邀请的角色已经结义
G_ERRCODE["JIEYI_INVITEROLE_LEVEL_NOT_ENOUGH"] = 873 --邀请的角色等级不够
G_ERRCODE["JIEYI_INVITEROLE_NUMBER_SURPASS"] = 874 --邀请的角色已经超过俩个了
G_ERRCODE["JIEYI_INVITEROLE_NOT_CREATED"] = 875 --结义没有创建
G_ERRCODE["JIEYI_HAS_CREATED"] = 876 --结义已经创建
G_ERRCODE["JIEYI_INVITEROLE_NOT_ACCEPT"] = 877--有人未接受邀请
G_ERRCODE["JIEYI_BOSS_NOT_FIND"] = 878 -- boss信息找不到
G_ERRCODE["JIEYI_BROTHER_NOT_FIND"] = 879 -- brother信息找不到
G_ERRCODE["JIEYI_BROTHER_NOT_INVITED"] = 880 -- 被邀请方已经创建结义 不可以邀请 
G_ERRCODE["JIEYI_REQUEST_TYPE_WRONG"] = 881 -- 请求参数type错误
G_ERRCODE["JIEYI_INFO_NOT_FOUND"] = 882 --请求的结义信息找不到
G_ERRCODE["JIEYI_INVITEREQUEST_CANCEL"] = 883 --邀请请求已经被取消

G_ERRCODE["PHOTO_SET_NO_PHOTO"] = 890  --头像设置没有这个头像
G_ERRCODE["PHOTO_SET_NO_PHOTO_FRAME"] = 891  --头像设置没有这个头像框

G_ERRCODE["YUEZHAN_HERO_LESS"] = 900  --请先设置约战阵容
G_ERRCODE["YUEZHAN_ROOM_ERR"] = 901  --加入的房间号不存在，已经取消了
G_ERRCODE["YUEZHAN_HAVE_ROLE"] = 902  --已经有人应战了，你可以观看他们的实时对战
G_ERRCODE["YUEZHAN_FINISH"] = 903  --实时对战已经结束，可以去查看录像
G_ERRCODE["YUEZHAN_CANCLE_ROLE"] = 904  --已经有人应战了，无法取消
G_ERRCODE["YUEZHAN_CANCLE_NOT_CREATE"] = 905  --你不是约战的发起者，不可以取消
G_ERRCODE["YUEZHAN_CREATER_JOIN"] = 906  --发起者不可以进入自己发起的约战
G_ERRCODE["YUEZHAN_BATTLE_STATE"] = 907	--你已经进入约战状态

G_ERRCODE["HERO_MAX_STAR"] = 920	--武将达到最大星级，无法进行升星

G_ERRCODE["SENDFLOWER_TO_SELF"] = 931 --不可以给自己发花
G_ERRCODE["SENDFLOWER_TIMES_UPPER"] = 932 --送花已经达到上线,不可以送花
G_ERRCODE["SENDFLOWER_MONEY_NOT_ENOUGH"] = 933 --送花所需钱币不够
G_ERRCODE["SENDFLOWER_YUANBAO_NOT_ENOUGH"] = 934 --送花所需元宝不够
G_ERRCODE["SENDFLOWER_COSTTYPE_NOT_EXIST"] = 935 --送花所需元宝不够
G_ERRCODE["SENDFLOWER_HAS_SEND"] = 936 --已经给被这个人送过花了，每天只可以送花一次
G_ERRCODE["SENDFLOWER_HAS_SEND"] = 937 --今天已经给这个人送过了
G_ERRCODE["SENDFLOWER_TYPE_NOT_RIGHT"] = 938 --送花方式不对
G_ERRCODE["SENDFLOWER_REWARD_TEMPLAT_ERROR"] = 939 --送花奖励模板找不到

G_ERRCODE["TOWER_ERROR_ARG"] = 950      --爬塔，参数错误  
G_ERRCODE["TOWER_ERROR_DATA"] = 951     --表格数据错误
G_ERRCODE["TOWER_ERROR_LEVEL"] = 952    --选择级别与等级不符
G_ERRCODE["TOWER_ERROR_LAYER"] = 953    --层数错误
G_ERRCODE["TOWER_ERROR_TYPE"] = 954     --类型错误
G_ERRCODE["TOWER_ERROR_GET_BOX"] = 955	--宝箱已经领取
G_ERRCODE["TOWER_ERROR_BUFF"] = 956		--buff数据不存在
G_ERRCODE["TOWER_ERROR_LESS_STAR"] = 957--星星数不够
G_ERRCODE["TOWER_ERROR_GET_BUFF"] = 958 --已经购买了BUFF
G_ERRCODE["TOWER_HERO_NOT_SELECTED"] = 959 --没有选择英雄
G_ERRCODE["TOWER_ERROR_ATTACK_ARMY_INFO"] = 959 --对手信息不存在
G_ERRCODE["TOWER_PARAM_HERO_NOT_EXIST"] = 960 --所选英雄不存在
G_ERRCODE["TOWER_PARAM_HERO_DEAD"] = 961 --所选英雄已经死亡
G_ERRCODE["TOWER_ERROR_SELECTED"] = 962	 --已经选择了塔的难度
G_ERRCODE["TOWER_ERROR_ARMY_SELECTED"] = 963 --已经选择了怪物难度
G_ERRCODE["TOWER_ERROR_GET_PRIZE_NOT_RANK"] = 964 --没有排名
G_ERRCODE["TOWER_ERROR_GET_PRIZE_HAVE_GET"] = 965 --已经领取
G_ERRCODE["TOWER_ERROR_SWEEP"] = 966     --不可扫荡

G_ERRCODE["SKIN_NOT_EXIST"] = 980      --装备的皮肤不存在
G_ERRCODE["SKIN_TIME_OUT"] = 981      --装备的皮肤已经过期无法装备
G_ERRCODE["SKIN_NOT_HERO"] = 982      --装备的皮肤不属于这个武将
G_ERRCODE["SKIN_GET_HERO_FIRST"] = 983      --请先获得这个武将再装备皮肤
G_ERRCODE["SKIN_BUY_HAVE"] = 984      --已经有这个皮肤了，不用购买了
G_ERRCODE["SKIN_BUY_NO_HERO"] = 985      --没有这个武将，无法购买皮肤
G_ERRCODE["SKIN_BUY_CAN_NOT_YUANBAO"] = 986      --这个皮肤不可以使用元宝购买
G_ERRCODE["SKIN_BUY_CAN_NOT_ITEM"] = 987      --这个皮肤不可以使用物品兑换
G_ERRCODE["SKIN_BUY_ITEM_LESS"] = 988      --这个皮肤物品兑换，物品不足
G_ERRCODE["SKIN_BUY_USING"] = 989      --这个皮肤已经在临时皮肤里了，不可以叠加使用

G_ERRCODE["DATI_NUM_ERR"] = 990 --题目数目错误
G_ERRCODE["DATI_RIGHT_FLAG_ERR"] = 991 --答题结果标识错误
G_ERRCODE["DATI_HAVE_OPENBOX_ERR"] = 992 --玩家已经开启过答题宝箱
G_ERRCODE["DATI_OPENBOX_FAIL_ERR"] = 993 --未全部答对本日题目，开启宝箱失败 
G_ERRCODE["DATI_REWARD_ERR"] = 994 --答题奖励错误
G_ERRCODE["DATI_UNFINISHED"] = 995 --未完成今日答题
G_ERRCODE["DATI_USETIME_ERR"] = 998 --答题用时错误

G_ERRCODE["TRIAL_NOTLINE"] = 996

G_ERRCODE["CHONGZHI_DISABLE"] = 997 --目前尚未开放充值


G_ERRCODE["MILITARY_ERROR_ARG"] = 1020	--参数错误
G_ERRCODE["MILITARY_ERROR_TEAM"] = 1021  --出战阵容错误，请重新设置出战阵容
G_ERRCODE["MILITARY_ERROR_TIMES"] = 1022  --挑战次数上限
G_ERRCODE["MILITARY_ERROR_CD"] = 1023  --挑战cd
G_ERRCODE["MILITARY_ERROR_LEVEL"] = 1024  --挑战等级不足
G_ERRCODE["MILITARY_ERROR_ACTIVIE"] = 1025  --活动尚未开启
G_ERRCODE["MILITARY_ERROR_HERO_TYPE"] = 1026  --武将类型错误
G_ERRCODE["MILITARY_ERROR_BATTLE_DATA"] = 1027 --战斗数据错误
G_ERRCODE["MILITARY_ERROR_DATA"] = 1028			--数据错误
G_ERRCODE["MILITARY_ERROR_VIP"] = 1029         --vip限制

G_ERRCODE["HOT_PVP_VIDEO_NOT_FOUND"] = 1051	--找不到录像

G_ERRCODE["ACTIVITY_NOT_EXIST"] = 1100         --活动不存在
G_ERRCODE["ACTIVITY_NOT_IN_REWARD_TIME"] = 1101         --不在活动领奖时间内
G_ERRCODE["ACTIVITY_CANNOT_GET_REWARD"] = 1102         --当前活动进度无法领取奖励
G_ERRCODE["ACTIVITY_ALREADY_GET_REWARD"] = 1103			--已经领取过奖励
...
G_ACH_TYPE["CONTINUTY_DAY"]  = 15		--连续7天登陆
G_ACH_TYPE["FLOWER_LINGERING"]  = 18		--余香成就
G_ACH_TYPE["CHONGZHI"]  = 19			--充值消费
G_ACH_TYPE["YONGJIU"]  = 20			--永久成就
G_ACH_TYPE["LESSNUM"]  = 21			--小于目标才算是完成的成就类型
G_ACH_TYPE["ZHANLI"]  = 22			--大于目标才算是完成的成就类型
G_ACH_TYPE["HERO"]  = 23			--收集指定武将
G_ACH_TYPE["HERO_TUPO"]  = 24			--拥有大于目标个指定阶的武将
G_ACH_TYPE["WUZHESHILIAN"]  = 25			--试炼达到目标层目标关
G_ACH_TYPE["HERO_STAR"]  = 26			--拥有大于目标个指定星级的武将
G_ACH_TYPE["WEAPON_LEVELUP"]  = 27			--拥有大于目标个指定等级的武器
G_ACH_TYPE["EQUIPMENT_LEVELUP"]  = 28			--拥有大于目标个指定等级的装备
G_ACH_TYPE["MILITARY"] = 29 		--军资相关成就

--类型2的成2级分类
G_ACH_TWO_TYPE = {}
G_ACH_TWO_TYPE["NORMAL"] = 0 --VIP普通奖励
G_ACH_TWO_TYPE["SPECIAL"] = 1 --VIP特权奖励
...
--类型8的成就的2级分类
G_ACH_EIGHT_TYPE = {}
G_ACH_EIGHT_TYPE["STAGE"] = 0			--关卡
G_ACH_EIGHT_TYPE["WUZHESHILIAN"] = 1		--武者试炼
G_ACH_EIGHT_TYPE["MASHUDASAI"] = 2		--马术大赛
G_ACH_EIGHT_TYPE["FLOWER"] = 3			--送花
G_ACH_EIGHT_TYPE["3V3"] = 4			--3V3取得胜利
G_ACH_EIGHT_TYPE["JJC"] = 5			--参加JJC
G_ACH_EIGHT_TYPE["BUYVP"] = 6			--购买体力
G_ACH_EIGHT_TYPE["LOTTERY"] = 7			--抽奖
G_ACH_EIGHT_TYPE["YANWUCHANG"] = 8		--演武场
G_ACH_EIGHT_TYPE["MAFIAJISI"] = 9		--联盟祭祀

--类型20的成就的2级分类  20主要是永久成就
G_ACH_TWENTY_TYPE = {}
G_ACH_TWENTY_TYPE["JJCWIN"] = 1			--JJC胜利场次
G_ACH_TWENTY_TYPE["JJCSCORE"] = 2		--JJC积分
G_ACH_TWENTY_TYPE["3V3WIN"] = 3			--3V3胜利场次
G_ACH_TWENTY_TYPE["3V3CHUANSHUOSCORE"] = 4	--3V3传说积分
G_ACH_TWENTY_TYPE["3V3CHUANSHUO"] = 5		--3V3达到传说段位
--G_ACH_TWENTY_TYPE["3V3JIEWEI"] = 6		--3V3阶别   不用了，放到21里面去
G_ACH_TWENTY_TYPE["MASHUSCORE"] = 7		--马术积分
G_ACH_TWENTY_TYPE["YUXIANG"] = 8		--送花余香
G_ACH_TWENTY_TYPE["FLOWER"] = 9			--获赠鲜花
G_ACH_TWENTY_TYPE["MAFIAJOIN"] = 10		--加入联盟
G_ACH_TWENTY_TYPE["MAFIAJISI"] = 11		--联盟祭祀
G_ACH_TWENTY_TYPE["MAFIAJITIAN"] = 12	--联盟祭天
G_ACH_TWENTY_TYPE["JIEWEI"] = 13   --阶位    
G_ACH_TWENTY_TYPE["DATIRIGHTNUM"] = 14   --答对题数
G_ACH_TWENTY_TYPE["DATIALLRIGHTTIME"] = 15   --答题全对次数

--类型21的成就的2级分类  21主要是小于某一个数值才算是完成的
G_ACH_TWENTYONE_TYPE = {}
G_ACH_TWENTYONE_TYPE["JJCRANK"] = 1		--JJC名次
G_ACH_TWENTYONE_TYPE["MASHURANK"] = 3		--马术大赛名次
G_ACH_TWENTYONE_TYPE["3V3GRADE"] = 2		--3V3阶别

G_ACH_TWENTYNIME_TYPE = {}
G_ACH_TWENTYNIME_TYPE["MILITARY_ALL_HURT1"]  = 1 --军资伤害输出达到值 
G_ACH_TWENTYNIME_TYPE["MILITARY_ALL_HURT2"]  = 2 --军资伤害输出达到值 
G_ACH_TWENTYNIME_TYPE["MILITARY_ALL_HURT3"]  = 3 --军资伤害输出达到值 
G_ACH_TWENTYNIME_TYPE["MILITARY_ALL_HURT4"]  = 4 --军资伤害输出达到值
...
G_KICKOUT_REASON["CLIENTID_ERR"] = 4--渠道ID错误
G_KICKOUT_REASON["FORBID_LOGIN"] = 5--玩家被禁止登陆
...
G_ROLE_STATE = {}
G_ROLE_STATE["FREE"]		= 0	--空闲状态
G_ROLE_STATE["INSTANCE"]	= 1	--关卡状态
G_ROLE_STATE["WUZHESHILIAN"]	= 2	--武者试炼状态
G_ROLE_STATE["MASHUDASAI"]	= 3	--马术大赛状态
G_ROLE_STATE["JINGJICHANG"]	= 4	--竞技场状态
G_ROLE_STATE["TONGQUETAI"]	= 5	--铜雀台状态
G_ROLE_STATE["BATTLEFIELD"]	= 6	--战役状态
G_ROLE_STATE["PVP"]		= 7	--PVP状态
G_ROLE_STATE["YUEZHAN"]		= 8	--约战状态
G_ROLE_STATE["TOWER"]     = 9 --扫塔状态

G_NOTICE_TYP = {}
G_NOTICE_TYP["ROLE"]		= 1     --玩家
G_NOTICE_TYP["HERO"]		= 2     --武将
G_NOTICE_TYP["NUM"]		= 3     --纯数字
G_NOTICE_TYP["WEAPON"]		= 4     --武器
G_NOTICE_TYP["SOURCE"]		= 5     --来源(num是id)
G_NOTICE_TYP["ITEM"]		= 6     --物品(id是物品tid)
G_NOTICE_TYP["GM"]		= 7     --GM公告

G_PVP_STATE_TYP = {}
G_PVP_STATE_TYP["3V3"]		= 1	--3V3
G_PVP_STATE_TYP["YUEZHAN"]      = 2	--玩家约战

G_YUEZHAN_STATE = {}

G_HERO_TEAM_TYP = {}
G_HERO_TEAM_TYP["YUEZHAN"]	= 1	--约战的阵容
...
G_LOTTERY_COST_TYPE = {}
G_LOTTERY_COST_TYPE["FREE"]	= 0	--免费招募
G_LOTTERY_COST_TYPE["ITEM"]	= 1	--物品招募
G_LOTTERY_COST_TYPE["YUANBAO"]	= 2	--元宝招募

G_ITEM_TYPE = {}
G_ITEM_TYPE["WEAPON"]		= 7	--weapon
G_ITEM_TYPE["HERO"]		= 21	--hero
--G_ITEM_TYPE["LOTTERY"]		= 22	--彩票

G_SOURCE_TYP = {}
G_SOURCE_TYP["NORMAL_RECRUIT"] = 1 --普通招募
G_SOURCE_TYP["HIGHER_RECRUIT"] = 2 --高级招募
G_SOURCE_TYP["APPOINT_RECRUIT"] = 3 --限时招募
G_SOURCE_TYP["VIP_RECRUIT"] = 4 --特权招募
G_SOURCE_TYP["ITEM_SHOP"] = 11 --道具商店
G_SOURCE_TYP["MASHU_SHOP"] = 12 --马术商店
G_SOURCE_TYP["PVE_SHOP"] = 13 --演武商店
G_SOURCE_TYP["PVP_SHOP"] = 14 --对战商店
G_SOURCE_TYP["VIP_SHOP"] = 15 --特权商店
G_SOURCE_TYP["NORMAL_STAGE"] = 21 --闯关
G_SOURCE_TYP["SPECIAL_STAGE"] = 22 --假想管卡
G_SOURCE_TYP["BATTLE"] = 23 --战役
G_SOURCE_TYP["TOWER"] = 24 --无双城探宝
G_SOURCE_TYP["WUZHESHILIAN"] = 25 --武者试炼
G_SOURCE_TYP["MASHU"] = 26 --马术大赛
G_SOURCE_TYP["WENDA"] = 27 --三国问答
G_SOURCE_TYP["SILVER_BOX"] = 41 --白银宝箱
G_SOURCE_TYP["GOLDEN_BOX"] = 42 --黄金宝箱
G_SOURCE_TYP["PLATINUM_BOX"] = 43 --白金宝箱
G_SOURCE_TYP["ACHIEVEMENT"] = 51 --成就奖励
G_SOURCE_TYP["DAILY_TASK"] = 52 --每日任务
G_SOURCE_TYP["DAILY_SIGN"] = 53 --每日签到
G_SOURCE_TYP["WEAPON_FORGE"] = 54 --天降神兵
G_SOURCE_TYP["MONTH_CARD"] = 55 --月卡
G_SOURCE_TYP["LITTLE_FUDAI"] = 56 --小福袋
G_SOURCE_TYP["BIG_FUDAI"] = 57 --大福袋
G_SOURCE_TYP["HERO"] = 58 --武将
G_SOURCE_TYP["FULIHUODONG"] = 59 --福利活动
G_SOURCE_TYP["WEAPONMAKE"] = 60 --打造武器
G_SOURCE_TYP["YUNYING"] = 1000 --运营发放

G_SHOP_TYP = {}
G_SHOP_TYP["PVP_SHOP"] = 7990 --对战商店
G_SHOP_TYP["PVE_SHOP"] = 7991 --演武商店
G_SHOP_TYP["MASHU_SHOP"] = 38090 --联盟商店
G_SHOP_TYP["ITEM_SHOP"] = 42897 --道具商店
G_SHOP_TYP["VIP_SHOP"] = 42898 --特权商店

G_LOTTERY_TYP = {}
G_LOTTERY_TYP["NORMAL_RECRUIT"] = 42587 --普通招募
G_LOTTERY_TYP["ONE_HIGHER_RECRUIT"] = 42588 --高级招募单抽
G_LOTTERY_TYP["TEN_HIGHER_RECRUIT"] = 42589 --高级招募十连抽
G_LOTTERY_TYP["TEN_NORMAL_RECRUIT"] = 46425 --普通招募十连抽
G_LOTTERY_TYP["ONE_LIMITE_RECRUIT"] = 8580     --限时招募单抽
G_LOTTERY_TYP["TEN_LIMITE_RECRUIT"] = 9003 --限时招募十连抽
G_LOTTERY_TYP["WEAPON_MAKE_ONE"] = 8578  --武器打造一次
G_LOTTERY_TYP["WEAPON_MAKE_TEN"] = 8579  --武器打造十次

G_BOX_TYP = {}
G_BOX_TYP["SILVER_BOX"] = 21825 --白银宝箱
G_BOX_TYP["GOLDEN_BOX"] = 21827 --黄金宝箱
G_BOX_TYP["PLATINUM_BOX"] = 21829 --白金宝箱

G_ITEM_TYP = {}
G_ITEM_TYP["ROLE_EXP"] = 1 --主角经验药
G_ITEM_TYP["HERO_EXP"] = 2 --武将经验药
G_ITEM_TYP["STRENGTHEN_ITEM"] = 3 --各系统强化道具
G_ITEM_TYP["FUNC_ITEM"] = 4 --各系统功能道具
G_ITEM_TYP["GIFT"] = 5 --礼包
G_ITEM_TYP["EQUIP_BAG"] = 6 --武将装备包
G_ITEM_TYP["WEAPON"] = 7 --武器
G_ITEM_TYP["TEASURE"] = 8 --宝物饰品
G_ITEM_TYP["EQUIP_MATERIAL"] = 9 --装备材料
G_ITEM_TYP["WUHUN"] = 11 --武将武魂
G_ITEM_TYP["TEASURE_PIECE"] = 12 --宝物碎片
G_ITEM_TYP["COIN"] = 20 --货币物品
G_ITEM_TYP["HERO"] = 21 --武将
G_ITEM_TYP["LOTTERY_ITEM"] = 22 --彩票道具
G_ITEM_TYP["EQUIP"] = 23 --武将装备
G_ITEM_TYP["USE_ITEM"] = 24 --主动使用彩票道具
G_ITEM_TYP["PHOTO_FRAME"] = 25 --头像框
G_ITEM_TYP["BADGE"] = 26 --徽章物品
G_ITEM_TYP["PHOTO"] = 27 --头像
G_ITEM_TYP["CHENGHAO"] = 29 --余香称号
G_ITEM_TYP["DRESS_TIYAN"] = 30 --时装使用券
G_ITEM_TYP["DRESS_PIECE"] = 31 --时装碎片
G_ITEM_TYP["FUDAI"] = 32 --福袋彩票

G_INSTANCE_TYP = {}
G_INSTANCE_TYP["NORMAL_STAGE"] = 0 --普通关卡
G_INSTANCE_TYP["SPECIAL_STAGE"] = 1 --假想关卡
G_INSTANCE_TYP["PRACTICE_STAGE"] = 2 --演武关卡

G_NOTICE_ID = {}
G_NOTICE_ID["GM"] = 17 --GM公告ID

G_TOPLIST_REFRESH_TYP = {}
G_TOPLIST_REFRESH_TYP["DAILY"] = 1 --每日刷新排行榜
G_TOPLIST_REFRESH_TYP["WEEK"] = 2 --每周刷新排行榜
