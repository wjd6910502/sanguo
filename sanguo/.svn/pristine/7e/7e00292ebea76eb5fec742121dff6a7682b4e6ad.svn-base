...
void TransServer::OnAddSession(Session::ID sid)
{
	...
	Thread::Mutex2::Scoped keeper(_session_map_lock);
...
bool TransServer::FindSessionAndChangeStatus(Session::ID sid, int cur_status, int to_status, Octets& server_rand2)
{
	Thread::Mutex2::Scoped keeper(_session_map_lock);
