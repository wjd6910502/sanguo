...
public:
	enum SESSION_STATUS
	{
		...
		SESSION_STATUS_WAITING_CHECKTOKEN_RE,
		SESSION_STATUS_PROCESSING_CHECKTOKEN_RE,
		SESSION_STATUS_OK,
	};
...
public:
	...
	GateServer() : accumulate_limit(0), _session_map_lock("GateServer::_session_map_lock") { }
