function OnMessage_TestYueZhanCreate(player, role, arg, others)
	player:Log("OnMessage_TestYueZhanCreate, "..DumpTable(arg).." "..DumpTable(others))
	...
	role._roledata._hero_all_team:Insert(1, data)
	--查看阵容
	local hero_team = role._roledata._hero_all_team:Find(1)
	...
	API_Log("111111111111111111111111111111111111111111111111111111111111111      yuezhan_info._id"..yuezhan_info._id)
end
