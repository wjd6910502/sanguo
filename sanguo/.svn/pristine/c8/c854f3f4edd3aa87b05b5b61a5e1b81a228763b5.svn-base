...
function DeserializeAndProcessMessage(ud, is, ...)
	...
	elseif msg.__type__ == 10020 then
		...
		OnMessage_TopListHeartBeat(toplist, msg, others)
	...
	elseif msg.__type__ == 10025 then
		...
		OnMessage_SendServerEvent(mist, msg, others)
	...
	elseif msg.__type__ == 10027 then
		...
		OnMessage_OpenServer(playermap, mafiamap, msg)
	elseif msg.__type__ == 10028 then
		--MiscHeartBeat

		local mist = API_GetLuaMiscManager(ud)
		OnMessage_MiscHeartBeat(mist, msg, others)
	elseif msg.__type__ == 10029 then
		--PvpSeasonFinish

		local mist = API_GetLuaMiscManager(ud)
		OnMessage_PvpSeasonFinish(mist, msg, others)
