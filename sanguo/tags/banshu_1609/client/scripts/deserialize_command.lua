...
function DeserializeAndProcessCommand(ud, is, ...)
	...
	elseif cmd.__type__ == 653 then
		--JieYiUpdateRoleInfo
		is_idx, cmd.id = Deserialize(is, is_idx, "string")
		is_idx, cmd.name = Deserialize(is, is_idx, "string")

		OnCommand_JieYiUpdateRoleInfo(player, role, cmd, others)
	elseif cmd.__type__ == 655 then
		--JieYiGetInfo_Re
		is_idx, cmd.id = Deserialize(is, is_idx, "string")
		is_idx, cmd.name = Deserialize(is, is_idx, "string")
		is_idx, cmd.level = Deserialize(is, is_idx, "number")
	...
	elseif cmd.__type__ == 677 then
		--JieYiDisolve_Re
		is_idx, cmd.retcode = Deserialize(is, is_idx, "number")

		OnCommand_JieYiDisolve_Re(player, role, cmd, others)
	elseif cmd.__type__ == 679 then
	...
	elseif cmd.__type__ == 10119 then
	...
	elseif cmd.__type__ == 10125 then
	...
	elseif cmd.__type__ == 10126 then
		--MafiaUpdateExp
		is_idx, cmd.exp = Deserialize(is, is_idx, "number")
		is_idx, cmd.level = Deserialize(is, is_idx, "number")
	...
	elseif cmd.__type__ == 10127 then
	...
	elseif cmd.__type__ == 10128 then
	...
	elseif cmd.__type__ == 10130 then
	...
	elseif cmd.__type__ == 10205 then
