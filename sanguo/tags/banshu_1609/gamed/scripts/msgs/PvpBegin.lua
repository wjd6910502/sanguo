...
--if role._roledata._base._id:ToStr()=="1001" then resp.port = 19231 end
--if role._roledata._base._id:ToStr()=="1002" then resp.port = 19231 end
--if role._roledata._base._id:ToStr()=="1004" then resp.port = 19231 end
--resp.port = 19231
