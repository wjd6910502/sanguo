...
function SerializeMessage(msg)
	...
	elseif msg.__type__ == "TestMafiaLevelUp" then
		Serialize(os, 55)
	elseif msg.__type__ == "MafiaUpdateNoticeInfo" then
		Serialize(os, 56)
		__SerializeStruct(os, "MafiaNoticeInfo", msg.notice_info)
	elseif msg.__type__ == "MafiaBangZhuSendMail" then
		Serialize(os, 57)
		Serialize(os, msg.id)
		Serialize(os, msg.name)
		Serialize(os, msg.subject)
		Serialize(os, msg.context)
	elseif msg.__type__ == "TopListUpdateInfo" then
		Serialize(os, 58)
	elseif msg.__type__ == "TopListInsertInfo" then
		Serialize(os, 59)
		Serialize(os, msg.typ)
		Serialize(os, msg.data)
	elseif msg.__type__ == "ClientTimeRequest" then
		Serialize(os, 60)
	...
	elseif msg.__type__ == "TestMessage4" then
		Serialize(os, 90004)
	elseif msg.__type__ == "JieYiUpdateReply" then
		Serialize(os, 10200)
		Serialize(os, msg.id)
		Serialize(os, msg.typ)
		Serialize(os, msg.name)
