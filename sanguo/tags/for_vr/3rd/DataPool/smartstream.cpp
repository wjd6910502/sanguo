...
{
  return clstd::strncmpT(pStr1, pStr2, nCount) == 0;
...
#if defined(_WIN32) || defined(_WINDOWS) || defined(_ANDROID)
_SS_TEMPL 
const typename _SS_IMPL::iterator& _SS_IMPL::end() const
#elif defined(_IOS)
_SS_TEMPL 
...
//#if defined(_WIN32) || defined(_WINDOWS) || defined(_ANDROID)
_SS_TEMPL
const typename _SS_IMPL::iterator _SS_IMPL::find(const iterator& itBegin, int nCount, ...) const
//#elif defined(_IOS)
