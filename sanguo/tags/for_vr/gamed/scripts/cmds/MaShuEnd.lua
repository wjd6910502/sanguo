function OnCommand_MaShuEnd(player, role, arg, others)
	...
	if open_box_num > 0 then
		...
		local iteminfo = iteminfo_it:GetValue()
		while iteminfo ~= nil do
			API_Log("11111111111111111111111111111111111111111111111111111111111111111")
			local tmp_item = {}
	...
	if arg.score > role._roledata._mashu_info._today_max_score then
		...
		TOP_InsertData(others.toplist._top_manager, 7, role._roledata._base._id, role._roledata._mashu_info._today_max_score, 
