...
using namespace clstd;
  ...
  GXBOOL DataPoolBuildTime::IntCheckTypeDecl(LPCTYPEDECL pTypeDecl, GXBOOL bCheck)
  {
    ...
    for(int i = 0;; i++) {
      ...
      clStringA strTypeName = type.Name;
      sBuildTimeTypeDeclDict[strTypeName] = type;
    }
    return TRUE;
  }
  ...
  void DataPoolBuildTime::PutTypeToDict(GXLPCSTR szTypeName)
  {
    ...
    case T_WORD:
    case T_SWORD:
      t._cbSize = sizeof(u16);
      break;
    case T_DWORD:
    case T_SDWORD:
    case T_FLOAT:
      t._cbSize = sizeof(u32);
      break;
    case T_QWORD:
    case T_SQWORD:
      t._cbSize = sizeof(u64);
      break;
    ...
    case T_STRINGA:
      ...
      t._cbSize = m_bPtr64 ? sizeof(u64) : sizeof(void*);
      m_bFixedPool = 0;
      break;
    case T_STRUCT:
    case T_STRUCTALWAYS:
      {
        ...
        t._cbSize = CalculateVarSize(type.as.Struct, aMemberDesc);
    ...
    case T_FLAG:
      {
        t._cbSize = sizeof(DataPool::Enum);
