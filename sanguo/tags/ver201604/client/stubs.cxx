...
static ServerStatus __stub_ServerStatus((void*)0);
...
static UDPP2PMakeHole __stub_UDPP2PMakeHole((void*)0);
void make_compile_unit_stubs_o_md5sum_no_change_no_use_but_do_not_delete_it___for_client() {} //非常山寨的解决重新编译md5sum保持不变的问题
};
