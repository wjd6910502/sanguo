...
class UDPSTUNRequest : public GNET::Protocol
{
	...
	{
		GLog::log(LOG_INFO, "GAMED::UDPSTUNRequest::Process, magic=%d, change_ip=%d, change_port=%d, sid=%u, thread=%u",
		          magic, change_ip, change_port, sid, (unsigned int)pthread_self());
