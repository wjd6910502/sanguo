...
public:
	...
	hash_map(const _Allocator & alloc = _Allocator()) : _M_ht(100,alloc) {}
	explicit hash_map(size_type __n, const _Allocator & alloc = _Allocator()): _M_ht(__n,alloc) {}
...
public:
	...
	bool operator==(const hash_map<_Key,_Value,_HashFunc,_Allocator>& rhs)
	{
