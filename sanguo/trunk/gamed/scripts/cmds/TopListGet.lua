	...
	if top~=nil then
		...
		if toplist~=nil then
			if arg.top_flag == 1 then
				...
				resp.reward_info = {}
				resp.reward_info[#resp.reward_info+1] = toplist._reward_info._new_data1
				resp.reward_info[#resp.reward_info+1] = toplist._reward_info._new_data2
			elseif arg.top_flag == 2 then
				...
				resp.reward_info = {}
				resp.reward_info[#resp.reward_info+1] = toplist._reward_info._old_data1
				resp.reward_info[#resp.reward_info+1] = toplist._reward_info._old_data2
			else
