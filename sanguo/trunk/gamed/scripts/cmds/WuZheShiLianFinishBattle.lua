function OnCommand_WuZheShiLianFinishBattle(player, role, arg, others)
	...
	local stage = arg.stage - (arg.difficulty-1)*quanju.shilian_stage_num_max
	local task_condition = arg.difficulty*100 + stage
	TASK_ChangeCondition(role, G_ACH_TYPE["WUZHESHILIAN"], task_condition, 1)
