...
msg_list["SyncNetTime"] = 
function(os, msg)
	Serialize(os, 83)

end

msg_list["UpdateSpecialTask"] = 
function(os, msg)
	Serialize(os, 84)
	Serialize(os, msg.hero_tupo)
	Serialize(os, msg.hero_star)
	Serialize(os, msg.weapon_level)
	Serialize(os, msg.equip_level)
	Serialize(os, msg.pverank)
	Serialize(os, msg.pvpgrade)
...
msg_list["GMCmd_MailTextToPlayer"] = 
function(os, msg)
	Serialize(os, 11001)
...
msg_list["GMCmd_MailToPlayer"] = 
function(os, msg)
	Serialize(os, 11004)
	Serialize(os, msg.mailid)
	Serialize(os, msg.session_id)
	Serialize(os, msg.sid)
...
function(os, msg)
	Serialize(os, 11005)
	Serialize(os, msg.id)
	Serialize(os, msg.order)
	Serialize(os, msg.amount)
	Serialize(os, msg.sid)
...
msg_list["ActiveCodeResult"] = 
function(os, msg)
	Serialize(os, 10037)
	Serialize(os, msg.retcode)
	Serialize(os, msg.type)
