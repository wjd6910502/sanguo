...
SGT_PveArena::SGT_PveArena(): Singleton("SGT_PveArena")
{
...
void SGT_PveArena::backup(const char *name, int64_t transaction_id)
{
...
void SGT_PveArena::restore(int64_t transaction_id)
{
	if(transaction_id == _transaction_id)
	{
