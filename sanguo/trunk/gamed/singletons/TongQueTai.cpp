...
SGT_TongQueTai::SGT_TongQueTai(): Singleton("SGT_TongQueTai")
{
...
void SGT_TongQueTai::backup(const char *name, int64_t transaction_id)
{
...
void SGT_TongQueTai::restore(int64_t transaction_id)
{
	if(transaction_id == _transaction_id)
	{
