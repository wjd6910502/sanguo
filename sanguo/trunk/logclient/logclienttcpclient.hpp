...
public:
	...
	std::string Identification() const { return "LogTCPClient"; }
	void SetAccumulate(size_t size) { accumulate_limit = size; }
	LogclientTcpClient() : accumulate_limit(0), conn_state(false), locker_state("LogTCPClient::locker_state"), backoff(BACKOFF_INIT) { }
