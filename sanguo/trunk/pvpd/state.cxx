...
GNET::Protocol::Manager::Session::State state_PVPUDPTransServer(_state_PVPUDPTransServer,
						sizeof(_state_PVPUDPTransServer)/sizeof(GNET::Protocol::Type), 30);
...
static GNET::Protocol::Type _state_PVPCenterClient[] = 
{
	RPC_PVPCREATE,
	PROTOCOL_PVPDELETE,
	PROTOCOL_PVPPAUSE_RE,
};

GNET::Protocol::Manager::Session::State state_PVPCenterClient(_state_PVPCenterClient,
						sizeof(_state_PVPCenterClient)/sizeof(GNET::Protocol::Type), 86400);
