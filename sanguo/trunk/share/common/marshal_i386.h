...
#include <map>
#include <set>
#include "new_common/byteorder.h"
#include "new_common/octets.h"
#include "new_common/aliasing.h"
#include <iostream>
#include "new_common/boo.h"
...
template<typename T>
Marshal::OctetsStream& Marshal::OctetsStream::operator << (const std::vector<T> &x) 
{
    return *this <<( MarshalContainer(x));
}
template <typename T>
Marshal::OctetsStream& Marshal::OctetsStream::operator << (const std::set<T> &x)
{
	return *this <<( MarshalContainer(x));
}
template<typename T>
Marshal::OctetsStream& Marshal::OctetsStream::operator << (const std::list<T> &x) 
{
    return *this <<( MarshalContainer(x));
}
template<typename T>
Marshal::OctetsStream& Marshal::OctetsStream::operator << (const std::deque<T> &x) 
{
    return *this <<( MarshalContainer(x));
}
template<typename T1, typename T2>
Marshal::OctetsStream& Marshal::OctetsStream::operator << (const std::map<T1, T2> &x) 
{
    return *this <<( MarshalContainer(x));
}

template<typename T>
const Marshal::OctetsStream& Marshal::OctetsStream::operator >> (const std::vector<T> &x) const
{
	return *this >>( MarshalContainer(x));			
}
template<typename T>
const Marshal::OctetsStream& Marshal::OctetsStream::operator >> (const std::set<T> &x) const
{
	return *this >>( MarshalContainer(x));			
}
template<typename T>
const Marshal::OctetsStream& Marshal::OctetsStream::operator >> (const std::deque<T> &x) const
{
	return *this >>( MarshalContainer(x));			
}
template<typename T>
const Marshal::OctetsStream& Marshal::OctetsStream::operator >> (const std::list<T> &x) const
{
	return *this >>( MarshalContainer(x));			
}
template<typename T1, typename T2>
const Marshal::OctetsStream& Marshal::OctetsStream::operator >> (const std::map<T1, T2> &x) const
{
	return *this >>( MarshalContainer(x));			
}
