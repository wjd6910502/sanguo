...
rsync -avzLc --delete --progress  --password-file=/home/test/wjd/rsyncd.passwd rsync://game@127.0.0.1:8873/Dist/for_check/sanguo/android/update/bin/* /var/www/sanguo-android/update/bin/apk
cp -f /var/www/sanguo-android/update/bin/apk/*.html /var/www/sanguo-android/update/bin/
cp -f /var/www/sanguo-android/update/bin/apk/*.txt /var/www/sanguo-android/update/bin/
cp -f /var/www/sanguo-android/update/bin/apk/*.xml /var/www/sanguo-android/update/bin/
